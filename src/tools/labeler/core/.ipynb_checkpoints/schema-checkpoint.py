...
def create_poultry_schema() -> Schema:
    ...
    return Schema(
        ...
        classes={0: "hen"},
        keypoints=[
            KeypointDef(name="tail_base", color="#FF6B6B", index=0),
            KeypointDef(name="tail_tip", color="#4ECDC4", index=1),
            KeypointDef(name="left_hock", color="#45B7D1", index=2),
            KeypointDef(name="right_hock", color="#96CEB4", index=3),
            KeypointDef(name="left_foot", color="#FFEAA7", index=4),
            KeypointDef(name="right_foot", color="#DDA0DD", index=5),
            KeypointDef(name="neck_back", color="#98D8C8", index=6),
            KeypointDef(name="middle_back", color="#F7DC6F", index=7),
